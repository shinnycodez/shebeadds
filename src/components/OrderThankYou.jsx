  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#FFF4EA] p-6 text-center">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full border-4 border-dashed border-pink-200">
        <div className="text-[#FFC4C4] text-5xl mb-4">
        ...
        <p className="text-[#FFC4C4]-600 mb-6">
          Your order has been placed successfully. 
        </p>
        <button
          onClick={handleContinueShopping}
          className="bg-[#FFC4C4] hover:bg-pink-500 text-white font-semibold px-6 py-3 rounded-full transition duration-300 shadow-md"
        >
          Continue Shopping
        </button>
      </div>
